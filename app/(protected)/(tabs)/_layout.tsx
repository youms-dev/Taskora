        ...
        <Tabs
            ...
            tabBar={() => (
                <Animated.View
                    ...
                    className="absolute bottom-0 border dark:border-white/20 border-black/20 overflow-hidden z-[9999]"
                >
                    {
                        minimize && (
                            <PressableAnimated
...

                    {
                        !minimize && (
                            <LinearGradient
                                ...
                                className="w-full flex-row justify-center items-center px-3 py-2"
                            >
                                <NavButton
                                    name={t("nav_tasks")}
                                    focused={pathname == "/"}
